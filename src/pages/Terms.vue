<template>
  <section class="section">
    ...
    <!--Section heading-->
    <h2 class="h1-responsive font-weight-bold text-center my-5">Terms and Conditions</h2>
    <p class="text-center w-responsive mx-auto mb-5">Please read these Terms and Conditions ("Terms", "Terms and Conditions") carefully 
        before using the http://www.mywebsite.com (change this) website and the My Mobile App (change this) mobile application 
        (the "Service") operated by My Company (change this) ("us", "we", or "our").
    </p>
    <div class="row">    
        ...
        <p>If you wish to purchase any product or service made available through the Service ("Purchase"), 
            ...
            For the full disclosure section, create your own Terms and Conditions.</p>
        <h3>Subscriptions</h3>
        <p>Some parts of the Service are billed on a subscription basis ("Subscription(s)"). 
            You will be billed in advance on a recurring ...The Subscriptions section is for SaaS businesses. 
            For the full disclosure section, create your own Terms and Conditions.</p>
        <h3>Content</h3>
        ...
        <p>Our Service may contain links to third-party web sites or services that are not owned or controlled by My Company 
            (change this).</p>
        <p>My Company (change this) has no control over, and assumes no responsibility for, the content, privacy policies, or practices of any third party web sites or services. 
            You further acknowledge and agree that My Company (change this) shall not be responsible or liable, directly or indirectly, 
